...
whole project needs to use them or they should not be used at all.
  ...
  * If the project already uses assembly definitions accessing a script that belongs to this asset can be done by adding an 
  ...
  adding a NWH.DWP2.ShipController reference to MyProject.asmdef is required.
...
Lux Water directory and a reference inside NWH.DWP2.WaterObject or removal of all .asmdef files from the asset if you do not wish to use assembly definitions. 
Some assets such as Crest already feature .asmdefs and adding Crest as a reference to NWH.DWP2.WaterObject is the only step needed.
