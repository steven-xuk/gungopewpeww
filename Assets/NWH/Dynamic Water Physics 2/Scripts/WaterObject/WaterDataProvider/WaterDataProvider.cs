...
namespace NWH.DWP2.WaterData
{
    ...
    public abstract class WaterDataProvider : MonoBehaviour
    {
        ...
        public bool useWaterNormals = true;
        public bool useWaterFlow   = true;
        ...
        public virtual void Awake()
        {
            Debug.Assert(Instance == null,
                         "There is more than one WaterDataProvider in the scene. Only one can be present" +
        ...
        {
            return GetWaterHeightSingle(worldPoint);
        }
    }
}