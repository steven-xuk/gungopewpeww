...
namespace NWH.DWP2
{
    ...
    public class WaterObjectEditor : DWP_NUIEditor
    {
        ...
        public override bool OnInspectorNUI()
        {
            ...
            if (Application.isPlaying && !_waterObject.Initialized)
            {
                drawer.Info("WaterObject has not yet been synchronized. Call WaterObjectManager.Synchronize() to register the object.", MessageType.Warning);
            }
            ...
            drawer.BeginSubsection("Per-Object Simulation Settings");
            drawer.Field("dynamicForceCoeff");
            drawer.Field("dynamicForcePowerCoeff");
            drawer.Field("skinFrictionDragCoeff");
